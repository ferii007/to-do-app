...
const SettingPage = () => {
    ...
    return(
        <div className={`h-screen absolute top-0 left-0 right-0 bottom-0 bg-white p-4 ${isSettingPage ? 'translate-x-0 z-50' : '-translate-x-full -z-50'} transition-all ease-in-out duration-500`}>
