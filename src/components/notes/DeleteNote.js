...
const DeleteNote = () => {
    ...
    return(
        <>
            {isShowDeleteNoteModal && <OverlayElement />}

            <div className={`absolute top-1/3 left-0 right-0 px-3 m-auto h-screen z-20 ${isShowDeleteNoteModal ? 'scale-100' : 'scale-0'} transition-all duration-300`}>
